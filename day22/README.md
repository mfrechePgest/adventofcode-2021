...
After running the above reboot steps, `_2758514936282235_` cubes are _on_. (Just for <span title="Well, *I* think it's fun.">fun</span>, `474140` of those are also in the initialization procedure region.)
